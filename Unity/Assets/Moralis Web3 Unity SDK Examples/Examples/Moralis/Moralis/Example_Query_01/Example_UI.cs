...
namespace MoralisUnity.Examples.Sdk.Example_Query_01	
{
	...
	public class Example_UI : MonoBehaviour
	{
		...
		private async UniTask SetupUI()
		{
			...
			// Header
			_exampleCanvas.Header.TitleText.text = "Query";
		...
		private async void CreateHeroButton_OnClicked()
		{
			...
			// Execute
			///////////////////////////////////////////
			Hero heroCreated = await Example_Query_01.Moralis_Create(_bottomBodyText);
		...
		private async void DeleteHeroButton_OnClicked()
		{
			...
			// Execute
			List<Hero> results = await Example_Query_01.Moralis_Query(_bottomBodyText);
			...
			{
				_bottomBodyText = 
					await Example_Query_01.Moralis_Delete(_bottomBodyText, heroToDelete);
			}
			else
			{
